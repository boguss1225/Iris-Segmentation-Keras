...
import os.path
fname = "keras_segmentation/models/mobilenet_1_0_224_tf_no_top.h5"
if not os.path.isfile(fname):
    import wget
    wget.download("https://github.com/fchollet/deep-learning-models/releases/download/v0.6/mobilenet_1_0_224_tf_no_top.h5", out = "keras_segmentation/models/")
    print("mobilenet checkpoint downloaded")
    
# BASE_WEIGHT_PATH = ('https://github.com/fchollet/deep-learning-models/releases/download/v0.6/')
BASE_WEIGHT_PATH = fname
